...
namespace BTL_ThiSinhThiDaiHoc
{
	public partial class DSTrungTuyen : Form
	{
		...
		private void btnXuat_Click(object sender, EventArgs e)
		{
			...
			tenvung.Value = "DANH SÁCH TRÚNG TUYỂN " + cbbNguyenVong.SelectedItem.ToString();
			...
			exSheet.get_Range("F2").Value = "Giới tính";
			exSheet.get_Range("G2").Value = "Ngày sinh";
		...
		private void btnXuatTat_Click(object sender, EventArgs e)
		{
			...
			foreach (DataRow item in dt.Rows)
			{
				...
				tenvung.Font.Color = Color.Red;
				tenvung.Value = "DANH SÁCH TRÚNG TUYỂN " + item["TenNguyenVong"].ToString();
				exSheet.get_Range("A1:M1").Merge(true);
